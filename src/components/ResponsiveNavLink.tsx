...
const ResponsiveNavLink = ({ active = false, children, ...props }: NextLinkProps) => (
    <Link
        ...
        className={`block pl-3 pr-4 py-2 border-l-4 text-base font-medium leading-5 focus:outline-none transition duration-150 ease-in-out ${
            active
                ? 'border-indigo-400 text-indigo-700 bg-indigo-50 dark:text-indigo-200 dark:bg-gray-800 focus:text-indigo-800 focus:bg-indigo-100 focus:border-indigo-700'
